...
export const DarkModeColor = {
  // Danger colors (100=darkest, 900=lightest, 600=brand)
  danger100: 'hsl(0 100% 10%)',
  danger200: 'hsl(0 100% 20%)',
  danger300: 'hsl(0 100% 30%)',
  danger400: 'hsl(0 67% 48%)',
  danger500: 'hsl(0 73% 51%)',
  danger600: 'hsl(0 79% 54%)',
  danger700: 'hsl(0 100% 60%)',
  danger800: 'hsl(0 100% 70%)',
  danger900: 'hsl(0 100% 85%)',

  // Neutral colors (100=darkest, 900=lightest)
  neutral100: 'hsl(0 0% 0%)',
  neutral200: 'hsl(240 3% 11%)',
  neutral300: 'hsl(240 2% 23%)',
  neutral400: 'hsl(240 1% 29%)',
  neutral500: 'hsl(240 1% 34%)',
  neutral600: 'hsl(240 1% 39%)',
  neutral700: 'hsl(240 2% 57%)',
  neutral800: 'hsl(240 1% 83%)',
  neutral900: 'hsl(0 0% 100%)',

  // Primary colors (100=darkest, 900=lightest, 600=brand)
  primary100: 'hsl(300 45% 11%)',
  primary200: 'hsl(300 48% 20%)',
  primary300: 'hsl(300 47% 35%)',
  primary400: 'hsl(300 43% 49%)',
  primary500: 'hsl(301 51% 56%)',
  primary600: 'hsl(302 59% 63%)',
  primary700: 'hsl(302 67% 72%)',
  primary800: 'hsl(301 72% 80%)',
  primary900: 'hsl(299 77% 90%)',

  // Secondary colors (100=darkest, 900=lightest)
  secondary100: 'hsl(200 71% 13%)',
  secondary200: 'hsl(197 69% 25%)',
  secondary300: 'hsl(201 70% 42%)',
  secondary400: 'hsl(202 71% 47%)',
  secondary500: 'hsl(201 78% 55%)',
  secondary600: 'hsl(200 85% 63%)',
  secondary700: 'hsl(199 86% 70%)',
  secondary800: 'hsl(198 85% 79%)',
  secondary900: 'hsl(196 86% 88%)',

  // Success colors (100=darkest, 900=lightest)
  success100: 'hsl(120 36% 10%)',
  success200: 'hsl(120 33% 21%)',
  success300: 'hsl(120 40% 35%)',
  success400: 'hsl(123 41% 45%)',
  success500: 'hsl(121 45% 54%)',
  success600: 'hsl(120 49% 62%)',
  success700: 'hsl(120 50% 71%)',
  success800: 'hsl(120 52% 80%)',
  success900: 'hsl(120 52% 88%)',

  // Warning colors (100=darkest, 900=lightest)
  warning100: 'hsl(40 100% 10%)',
  warning200: 'hsl(40 100% 20%)',
  warning300: 'hsl(42 100% 30%)',
  warning400: 'hsl(36 75% 49%)',
  warning500: 'hsl(36 82% 52%)',
  warning600: 'hsl(35 89% 55%)',
  warning700: 'hsl(34 89% 63%)',
  warning800: 'hsl(36 90% 72%)',
  warning900: 'hsl(37 92% 80%)',
